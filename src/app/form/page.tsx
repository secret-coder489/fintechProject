      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-10">
        <FormSection title="Personal Information">
          ...
          <SelectField
            ...
            options={['high school', 'bachelor', 'master', 'doctorate', 'other']}
          />
          <InputField label="Occupation" {...register('occupation')} error={errors.occupation?.message} /> {/* <-- added */}
        ...
        <FormSection title="Employment Details">
          ...
          <SelectField
            ...
            options={['citizen', 'permanent resident', 'visa holder', 'other']}
          />
        </FormSection>
...
const InputField = ({ label, error, ...props }: any) => (
  <div>
    ...
    <input
      {...props}
      className={`w-full border rounded-md px-4 py-2 shadow-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 ${error ? 'border-red-500' : 'border-gray-300'
        }`}
    />
